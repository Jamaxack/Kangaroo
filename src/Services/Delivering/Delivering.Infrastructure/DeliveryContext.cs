...
{
    public class DeliveringContext : DbContext, IUnitOfWork
    {
        ...
        public DeliveringContext(DbContextOptions<DeliveringContext> options, IMediator mediator) : base(options)
        {

...
{
    public class DeliveryStatusChangedToCourierPickedUpDomainEventHandler : INotificationHandler<Domain.Events.DeliveryStatusChangedToCourierPickedUpDomainEvent>
    {
        ...
        public Task Handle(Domain.Events.DeliveryStatusChangedToCourierPickedUpDomainEvent notification, CancellationToken cancellationToken)
        {

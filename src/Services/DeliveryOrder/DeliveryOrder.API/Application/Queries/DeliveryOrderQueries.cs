    ...
    public class DeliveryOrderQueries : IDeliveryOrderQueries
    {
        ...
        const string SelectDeliveryOrdersQuery =
            @"SELECT 
	                ...
	                do.[Weight],
	                do.[Note],
	                do.[DeliveryOrderNotificationSettings_ShouldNotifySenderOnDeliveryOrderStatusChange] as ShouldNotifySenderOnDeliveryOrderStatusChange,
	                do.[DeliveryOrderNotificationSettings_ShouldNotifyRecipientOnDeliveryOrderStatusChange] as ShouldNotifyRecipientOnDeliveryOrderStatusChange,
	                do.[ClientId],
	                do.[CourierId],
        ...
        const string SelectDeliveryOrderByIdSqlQuery =
            @"SELECT TOP(1)
                    do.[Id],
                       ...
                       [Weight],
                       [Note],
                       [DeliveryOrderNotificationSettings_ShouldNotifySenderOnDeliveryOrderStatusChange] as ShouldNotifySenderOnDeliveryOrderStatusChange,
                       [DeliveryOrderNotificationSettings_ShouldNotifyRecipientOnDeliveryOrderStatusChange] as ShouldNotifyRecipientOnDeliveryOrderStatusChange,
                       [ClientId],
                       [CourierId],
	                   dos.[Name] as DeliveryOrderStatus
        ...
        DeliveryOrderViewModel MapToDeliveryOrderViewModel(dynamic queryResult)
        {
            var deliveryOrder = new DeliveryOrderViewModel
            {
                ...
                ShouldNotifySenderOnDeliveryOrderStatusChange = queryResult[0].ShouldNotifySenderOnDeliveryOrderStatusChange,
                ShouldNotifyRecipientOnDeliveryOrderStatusChange = queryResult[0].ShouldNotifyRecipientOnDeliveryOrderStatusChange,
